...
router.post('/minecraft/whitelist/enable', ui.allow, minecraftController.enableWhitelist.bind(minecraftController));
router.post('/minecraft/whitelist/disable', ui.allow, minecraftController.disableWhitelist.bind(minecraftController));
